...
class _GroupSettingPageState extends State<GroupSettingPage> {
  ...
  Future<void> moveToMainUiPage(BuildContext context) async {
    Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) =>
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () async {
                ...
                await groupsProvider.groupAssign(groupId);
                moveToMainUiPage(context);
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                final groupsProvider = Provider.of<GroupsProvider>(context, listen: false);
                groupsProvider.createGroup(context, newGroupName);
                moveToMainUiPage(context);
                Navigator.of(context).pop(); // 다이얼로그 닫기
              },
              child: const Text('확인'),
